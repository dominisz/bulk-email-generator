...
enum Testcase {
  ...
  EDGE_CASES(
      List.of(
          ...
          "line|Multi",
          "line)"),
      List.of("No choice", "", "Lotsa 3 choices", "Does it unwrap?", "Multi", "line")),
  ...
  MORE_EDGE_CASES(
      List.of(
          ...
          "by two|Two",
          "lines)"),
      List.of("", "No choice", "Lotsa 3 choices", "Does it blend?", "Lines", "by two"));

  private final Object input;
  private final Object output;

  Testcase(Object input, Object output) {
    this.input = input;
    this.output = output;
  }
